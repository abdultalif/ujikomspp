<?php
  ...
  $petugas=$sql->num_rows;

  $sql2 = $koneksi->query("select * from tb_spp");
  $spp=$sql2->num_rows;

  $sql3 = $koneksi->query("select * from tb_kelas");
  $kelas=$sql3->num_rows;

  $sql4 = $koneksi->query("select * from tb_siswa");
  $siswa=$sql4->num_rows;
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Data Spp</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $spp; ?></div>
                    </div>
                    <div class="col-auto">
