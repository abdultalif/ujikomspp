              ...
              <div class="col-lg-8">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Masuk SPP</h1>
                  </div>
                  <form method="post">
...
<?php
 include 'koneksi.php';
    if (isset($_POST['login'])) {
      ...
      $sql = $koneksi->query("SELECT * from tb_petugas where username='$username' and password='$pass'");
      ...
      if ($ketemu >=1) {
        ...
        elseif ($data['level']=="siswa") {
          $_SESSION['siswa']= $data['id_petugas'];
          header("location:index.php");
        }
